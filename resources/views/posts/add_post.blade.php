...
<form class="form-horizontal col-sm-10" method="POST" enctype="multipart/form-data">
	{{ csrf_field() }}
	<div class="form-group">
		<label class="control-label col-sm-10" for="title">Post Title:</label>
		<div class="col-sm-10">
			<input type="title" class="form-control" id="title" name="title" value="{{ old('title')}}">
		</div>
	</div>
	<div class="form-group">
		<label class="control-label col-sm-10" for="content">Post Content:</label>
		<div class="col-sm-10"> 
			<textarea class="form-control" id="content" name="content">{{ old('content')}}</textarea>
		</div>
	</div>
		<div class="form-group">
			<label class="control-label col-sm-10" for="category">Post Category:</label>
			<div class="col-sm-10">
		...
		<div class="form-group">
			<label class="control-label col-sm-10" for="image">Upload Image:</label>
			<div class="col-sm-10">
